...
$(document).ready(function () {
    ...
    if ($('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(".to-do-list input[type=checkbox]").on("click", function () {
        ...
        $(".pcoded-content").toggleClass("mychange");
        $(".pcoded-inner-content").toggleClass("mychange");
        $(".pcoded-content2").toggleClass("mychange");
        $(".pcoded-inner-content2").toggleClass("mychange");
        $(".title").toggleClass("mychange");
